<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Bản dịch Danh mục sản phẩm</h2>
		<ol class="breadcrumb">
			<li>
				<a href="<?php echo site_url('admin'); ?>">Home</a>
			</li>
			<li class="active"><strong>Bản dịch Danh mục sản phẩm</strong></li>
		</ol>
	</div>
</div>
			...
			<div class="ibox ibox-seo mb20">
				...
				<div class="ibox-content">
					<div class="row">
						<div class="col-lg-12">
							<?php
								$object_metaTitle = (isset($object['meta_title']) && $object['meta_title'] != '' ? $object['meta_title'] : 'Bạn chưa nhập tiêu đề SEO cho bài viết');
								$object_googleLink = (isset($object['canonical']) && $object['canonical'] != '' ?  BASE_URL.$object['canonical'].HTSUFFIX : BASE_URL.'duong-dan-website'.HTSUFFIX);
								$object_metaDescription = (isset($object['meta_description']) && $object['meta_description'] != '' ? $object['meta_description'] : 'Bạn Chưa nhập mô tả SEO cho bài viết');
							?>
							<div class="google">
								<div class="o-title"><?php echo $object_metaTitle; ?></div>
								<div class="o-link"><?php echo $object_googleLink ?></div>
								<div class="o-description" id="metaDescription">
									<?php echo $object_metaDescription; ?>
								</div>
							</div>
						</div>
					</div>
